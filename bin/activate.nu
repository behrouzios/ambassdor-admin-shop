...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/behrouzios/Python/Web Projects/Antonio Papa/React-Djngo-env/env'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/behrouzios/Python/Web Projects/Antonio Papa/React-Djngo-env/env/bin/deactivate.nu'
